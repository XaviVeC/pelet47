...
# Convertir la columna DATA a string para que sea serializable
...
# Convertir a formato JSON y mostrarlo como string
json_string = json.dumps(json_array, indent=2, ensure_ascii=False)
print(json_string)
